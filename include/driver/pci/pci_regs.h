/**
 * @file
 * @brief PCI and PCI Express configuration space register definitions.
 */
 ...
 *
 * Macro values in this header are derived from publicly documented PCI and PCI Express specifications.
 */
#ifndef __INCLUDE_DRIVER_PCI_PCI_REGS_H__
#define __INCLUDE_DRIVER_PCI_PCI_REGS_H__

// clang-format off

/*
 * PCI configuration space sizes:
 * - Conventional PCI / PCI-X Type 0 and Type 1 headers expose 256 bytes.
 * - PCI Express extends configuration space to 4096 bytes.
 */
#define PCI_CFG_SPACE_SIZE      256
#define PCI_CFG_SPACE_EXP_SIZE  4096

/*
 * Bytes 0x00-0x3f are the standard header region. The first 16 bytes are
 * common to all header types and identify the function, class, and command
 * or status state reported by the device.
 */
#define PCI_STD_HEADER_SIZEOF   64
#define PCI_STD_NUM_BARS        6
#define PCI_VENDOR_ID           0x00    /* Function vendor identifier */
#define PCI_DEVICE_ID           0x02    /* Function device identifier */
...
#define PCI_CLASS_REVISION      0x08    /* Class code in [31:8], revision in [7:0] */
#define PCI_REVISION_ID         0x08    /* Revision identifier */
#define PCI_CLASS_PROG          0x09    /* Programming interface byte */
#define PCI_CLASS_DEVICE        0x0a    /* Base class and subclass */
#define PCI_CACHE_LINE_SIZE     0x0c    /* Cache line size */
#define PCI_LATENCY_TIMER       0x0d    /* Latency timer */
#define PCI_HEADER_TYPE         0x0e    /* Header layout selector */
#define PCI_HEADER_TYPE_MASK           0x7f
#define PCI_HEADER_TYPE_NORMAL         0
#define PCI_HEADER_TYPE_BRIDGE         1
#define PCI_HEADER_TYPE_CARDBUS        2
#define PCI_HEADER_TYPE_MFD            0x80
#define PCI_BIST                0x0f    /* Built-In Self-Test register */
#define PCI_BIST_CODE_MASK     0x0f
#define PCI_BIST_START         0x40
#define PCI_BIST_CAPABLE       0x80

/*
 * Header Type 0 layout for ordinary endpoints. BARs at 0x10-0x27 describe
 * up to six I/O or memory apertures. The remaining fields cover subsystem
 * identity, optional expansion ROM decoding, and legacy interrupt wiring.
 */
...
#define PCI_SUBSYSTEM_VENDOR_ID 0x2c    /* Subsystem vendor identifier */
#define PCI_SUBSYSTEM_ID        0x2e    /* Subsystem device identifier */
#define PCI_ROM_ADDRESS         0x30    /* Expansion ROM base address */
#define PCI_ROM_ADDRESS_ENABLE 0x01
#define PCI_ROM_ADDRESS_MASK    (~0x7ffU)
#define PCI_CAPABILITY_LIST     0x34    /* First conventional capability pointer */
#define PCI_INTERRUPT_LINE      0x3c    /* Legacy interrupt line */
#define PCI_INTERRUPT_PIN       0x3d    /* INTA#..INTD# selector */
#define PCI_MIN_GNT             0x3e    /* Minimum grant hint */
#define PCI_MAX_LAT             0x3f    /* Maximum latency hint */

/*
 * Header Type 1 layout for PCI-to-PCI bridges. Bus number fields identify the
 * primary, secondary, and subordinate buses, while the I/O, memory, and
 * prefetchable windows describe forwarding ranges behind the bridge.
 */
#define PCI_PRIMARY_BUS         0x18    /* Upstream bus number */
#define PCI_SECONDARY_BUS       0x19    /* Downstream bus number */
#define PCI_SUBORDINATE_BUS     0x1a    /* Highest bus number downstream */
#define PCI_SEC_LATENCY_TIMER   0x1b    /* Secondary interface latency timer */
#define PCI_IO_BASE             0x1c    /* Downstream I/O base */
#define PCI_IO_LIMIT            0x1d    /* Downstream I/O limit */
...
#define PCI_MEMORY_BASE         0x20    /* Downstream non-prefetchable memory base */
#define PCI_MEMORY_LIMIT        0x22    /* Downstream non-prefetchable memory limit */
#define PCI_MEMORY_RANGE_TYPE_MASK 0x0fUL
#define PCI_MEMORY_RANGE_MASK  (~0x0fUL)
#define PCI_PREF_MEMORY_BASE    0x24    /* Downstream prefetchable memory base */
#define PCI_PREF_MEMORY_LIMIT   0x26    /* Downstream prefetchable memory limit */
#define PCI_PREF_RANGE_TYPE_MASK 0x0fUL
#define PCI_PREF_RANGE_TYPE_32 0x00
#define PCI_PREF_RANGE_TYPE_64 0x01
#define PCI_PREF_RANGE_MASK    (~0x0fUL)
#define PCI_PREF_BASE_UPPER32   0x28    /* Upper 32 bits for 64-bit prefetch base */
#define PCI_PREF_LIMIT_UPPER32  0x2c    /* Upper 32 bits for 64-bit prefetch limit */
#define PCI_IO_BASE_UPPER16     0x30    /* Upper 16 bits for 32-bit I/O base */
#define PCI_IO_LIMIT_UPPER16    0x32    /* Upper 16 bits for 32-bit I/O limit */
#define PCI_ROM_ADDRESS1        0x38    /* Bridge expansion ROM base address */
...
/*
 * Header Type 2 layout for CardBus bridges. The fixed windows and bridge
 * control fields map CardBus memory and I/O apertures to the parent PCI bus.
 */
#define PCI_CB_CAPABILITY_LIST  0x14    /* First capability pointer */
#define PCI_CB_SEC_STATUS       0x16    /* Secondary status register */
#define PCI_CB_PRIMARY_BUS      0x18    /* Parent PCI bus number */
#define PCI_CB_CARD_BUS         0x19    /* CardBus bus number */
#define PCI_CB_SUBORDINATE_BUS  0x1a    /* Highest CardBus bus number */
...
/*
 * Conventional capability list entries start with an 8-bit capability ID and
 * an 8-bit next pointer. IDs below describe the capability payload that begins
 * at the same list entry.
 */
...
/* Power Management Capability and PMCSR register layout. */
#define PCI_PM_PMC              2
...
/* MSI and MSI-X capability layouts. */
...
/* Advanced Features capability, including function-level reset. */
...
/* PCI-X capability registers for endpoints and bridges. */
#define PCI_X_CMD               2
...
/*
 * PCI Express Capability structure. Offsets are relative to the start of the
 * capability body, immediately after the conventional capability header.
 */
...
/*
 * PCI Express extended capability header. Every extended capability begins
 * with a 32-bit header containing the capability ID, version, and next link.
 */
...
/* Root Complex Event Collector association registers. */
...
/* Vendor-Specific and Designated Vendor-Specific headers. */
#define PCI_VNDR_HEADER         4
#define PCI_VNDR_HEADER_ID(x)  ((x) & 0xffff)
#define PCI_VNDR_HEADER_REV(x) (((x) >> 16) & 0xf)
#define PCI_VNDR_HEADER_LEN(x) (((x) >> 20) & 0xfff)

/* HyperTransport capability type encoding. */
...
/* Alternative Routing-ID Interpretation extended capability. */
...
/* Address Translation Service extended capability. */
...
/* Page Request Interface extended capability. */
...
/* Single Root I/O Virtualization extended capability. */
...
/* SATA capability defined for AHCI-style register mapping. */
...
/* Dynamic Power Allocation extended capability. */
...
/* ASPM L1 PM Substates extended capability. */
...
/* Data Link Feature and physical layer 16.0 GT/s capability blocks. */
...
/* Data Object Exchange extended capability and mailbox data object layout. */
...
#endif /* __INCLUDE_DRIVER_PCI_PCI_REGS_H__ */
