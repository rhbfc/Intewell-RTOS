...
#define SHELL_EXPORT_CMD(_attr, _name, _func, _desc)                           \
    ...
    extern "C" SHELL_USED const ShellCommandCppCmd                             \
        shellCommand##_name SHELL_SECTION (".shell.command")                   \
        = { _attr, shellCmd##_name, (int (*) ())_func, shellDesc##_name }
...
#define SHELL_EXPORT_VAR(_attr, _name, _value, _desc)                          \
    ...
    extern "C" SHELL_USED const ShellCommandCppVar                             \
        shellVar##_name SHELL_SECTION (".shell.command")                       \
        = { _attr, shellCmd##_name, (void *)_value, shellDesc##_name }
...
#define SHELL_EXPORT_USER(_attr, _name, _password, _desc)                      \
    ...
    extern "C" SHELL_USED const ShellCommandCppUser                            \
        shellUser##_name SHELL_SECTION (".shell.command")                      \
        = { _attr | SHELL_CMD_TYPE (SHELL_TYPE_USER), shellCmd##_name,         \
            shellPassword##_name, shellDesc##_name }
...
#define SHELL_EXPORT_KEY(_attr, _value, _func, _desc)                          \
    ...
    extern "C" SHELL_USED const ShellCommandCppKey                             \
        shellKey##_value SHELL_SECTION (".shell.command")                      \
        = { _attr | SHELL_CMD_TYPE (SHELL_TYPE_KEY), _value,                   \
            (void (*) (Shell *))_func, shellDesc##_value }
