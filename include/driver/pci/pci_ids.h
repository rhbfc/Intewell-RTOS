/**
 * @file
 * @brief PCI class, vendor, and device identifier definitions.
 */
 ...
 *
 * Macro values in this header are derived from publicly documented PCI class code assignments and identifier registries.
 */
#ifndef __INCLUDE_DRIVER_PCI_PCI_IDS_H__
#define __INCLUDE_DRIVER_PCI_PCI_IDS_H__

// clang-format off

/*
 * PCI class code encoding:
 * - Base class selects the broad function category.
 * - Subclass and programming interface further identify the device type.
 */
...
/* Programming interface value for 16550-compatible UARTs. */
...
/* Processor and coprocessor functions. */
...
/* Serial bus controllers such as USB, SMBus, and IPMI. */
...
/* Wireless and radio controllers. */
...
/* Signal processing and accelerator devices. */
...
/* Catch-all value used by some software for nonstandard classes. */
#define PCI_CLASS_OTHERS                                            0xff

/*
 * Vendor and device identifiers:
 * - Vendor IDs are allocated by PCI-SIG.
 * - Device IDs are assigned by the corresponding vendor.
 * - Entries below remain sorted by vendor ID and then device ID.
 */
...
#define PCI_DEVICE_ID_REDHAT_QEMU_XHCI                              0x000d
...
#endif /* __INCLUDE_DRIVER_PCI_PCI_IDS_H__ */
