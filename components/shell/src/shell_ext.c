...
int shellExtRun (Shell *shell, ShellCommand *command, int argc, char *argv[])
{
    ...
    case 0:
        return ((sh_func0_t)command->data.cmd.function) ();
        // break;
#endif /** SHELL_PARAMETER_MAX_NUMBER >= 1 */
#if SHELL_PARAMETER_MAX_NUMBER >= 2
    case 1:
        return ((sh_func1_t)command->data.cmd.function) (params[0]);
        // break;
#endif /** SHELL_PARAMETER_MAX_NUMBER >= 2 */
#if SHELL_PARAMETER_MAX_NUMBER >= 3
    case 2:
        return ((sh_func2_t)command->data.cmd.function) (params[0], params[1]);
        // break;
#endif /** SHELL_PARAMETER_MAX_NUMBER >= 3 */
#if SHELL_PARAMETER_MAX_NUMBER >= 4
    case 3:
        return ((sh_func3_t)command->data.cmd.function) (params[0], params[1], params[2]);
        // break;
#endif /** SHELL_PARAMETER_MAX_NUMBER >= 4 */
#if SHELL_PARAMETER_MAX_NUMBER >= 5
    case 4:
        return ((sh_func4_t)command->data.cmd.function) (params[0], params[1], params[2],
                                           params[3]);
        // break;
#endif /** SHELL_PARAMETER_MAX_NUMBER >= 5 */
#if SHELL_PARAMETER_MAX_NUMBER >= 6
    case 5:
        return ((sh_func5_t)command->data.cmd.function) (params[0], params[1], params[2],
                                           params[3], params[4]);
        // break;
#endif /** SHELL_PARAMETER_MAX_NUMBER >= 6 */
#if SHELL_PARAMETER_MAX_NUMBER >= 7
    case 6:
        return ((sh_func6_t)command->data.cmd.function) (params[0], params[1], params[2],
                                           params[3], params[4], params[5]);
        // break;
#endif /** SHELL_PARAMETER_MAX_NUMBER >= 7 */
#if SHELL_PARAMETER_MAX_NUMBER >= 8
    case 7:
        return ((sh_func7_t)command->data.cmd.function) (params[0], params[1], params[2],
                                           params[3], params[4], params[5],
                                           params[6]);
        // break;
    ...
    case 8:
        return ((sh_func8_t)command->data.cmd.function) (params[0], params[1], params[2],
                                           params[3], params[4], params[5],
                                           params[6], params[7]);
        // break;
    ...
    case 9:
        return ((sh_func9_t)command->data.cmd.function) (params[0], params[1], params[2],
                                           params[3], params[4], params[5],
    ...
    case 10:
        return ((sh_func10_t)command->data.cmd.function) (
    ...
    case 11:
        return ((sh_func11_t)command->data.cmd.function) (
            params[0], params[1], params[2], params[3], params[4], params[5],
    ...
    case 12:
        return ((sh_func12_t)command->data.cmd.function) (
            params[0], params[1], params[2], params[3], params[4], params[5],
    ...
    case 13:
        return ((sh_func13_t)command->data.cmd.function) (
            params[0], params[1], params[2], params[3], params[4], params[5],
            params[6], params[7], params[8], params[9], params[10], params[11],
            params[12]);
        // break;
    ...
    case 14:
        return ((sh_func14_t)command->data.cmd.function) (
            params[0], params[1], params[2], params[3], params[4], params[5],
            params[6], params[7], params[8], params[9], params[10], params[11],
            params[12], params[13]);
        // break;
    ...
    case 15:
        return ((sh_func15_t)command->data.cmd.function) (
            params[0], params[1], params[2], params[3], params[4], params[5],
            params[6], params[7], params[8], params[9], params[10], params[11],
