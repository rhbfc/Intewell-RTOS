...
/****************************************************************************
 * 本文件基于 Apache NuttX 对应 can 接口定义移植到当前 RTOS，
 * 并已针对本地目录结构和平台环境进行了修改。
 ****************************************************************************/

#ifndef __INCLUDE_CAN_FRAMWORK_H
#define __INCLUDE_CAN_FRAMWORK_H
...
#endif /* __INCLUDE_CAN_FRAMWORK_H */
