...
#ifndef _FS_FS_IOCTL_H
#define _FS_FS_IOCTL_H
...
#define FIOC_TRUNCATE                                                          \
    0x6502 /* IN:  Length of the file after truncate                           \
            * OUT: None                                                        \
            */

#define FIOC_MMAP                                                              \
    0x6503 /* IN:  Location to return address (void **) */                     \
...
#define _FS_IOC_MASK      (0x00ff)
#define _FS_IOC_TYPE(cmd) ((cmd) & ~_FS_IOC_MASK)
#define _FS_IOC_NR(cmd)   ((cmd)&_FS_IOC_MASK)

#define _FS_IOC(type, nr) ((type) | (nr))

/* Terminal I/O ioctl commands **********************************************/

#define _TIOCVALID(c) (_FS_IOC_TYPE (c) == _TIOCBASE)
#define _TIOC(nr)     _FS_IOC (_TIOCBASE, nr)
...
#define _WDIOCVALID(c) (_FS_IOC_TYPE (c) == _WDIOCBASE)
#define _WDIOC(nr)     _FS_IOC (_WDIOCBASE, nr)

/* NuttX file system ioctl definitions **************************************/

#define _FIOCVALID(c) (_FS_IOC_TYPE (c) == _FIOCBASE)
#define _FIOC(nr)     _FS_IOC (_FIOCBASE, nr)
...
#define FIOC_FILEPATH                                                          \
    _FIOC (0x0003) /* IN:  char *(length >= PATH_MAX)                          \
...
#ifdef CONFIG_FDSAN
#define FIOC_SETTAG                                                            \
    _FIOC (0x000e) /* IN:  uint64_t *                                          \
                    * Pointer to file tag                                      \
                    * OUT: None                                                \
                    */

#define FIOC_GETTAG                                                            \
    _FIOC (0x000f) /* IN:  uint64_t *                                          \
                    * Pointer to file tag                                      \
                    * OUT: None                                                \
                    */
#endif
...
#define _DIOCVALID(c) (_FS_IOC_TYPE (c) == _DIOCBASE)
#define _DIOC(nr)     _FS_IOC (_DIOCBASE, nr)
...
#define _BIOCVALID(c) (_FS_IOC_TYPE (c) == _BIOCBASE)
#define _BIOC(nr)     _FS_IOC (_BIOCBASE, nr)
...
#define _MTDIOCVALID(c) (_FS_IOC_TYPE (c) == _MTDIOCBASE)
#define _MTDIOC(nr)     _FS_IOC (_MTDIOCBASE, nr)

/* Socket IOCTLs ************************************************************/

/* See include/nuttx/net/ioctl.h */

#define _SIOCVALID(c) (_FS_IOC_TYPE (c) == _SIOCBASE)
#define _SIOC(nr)     _FS_IOC (_SIOCBASE, nr)

/* NuttX ARP driver ioctl definitions (see netinet/arp.h) *******************/

#define _ARPIOCVALID(c) (_FS_IOC_TYPE (c) == _ARPIOCBASE)
#define _ARPIOC(nr)     _FS_IOC (_ARPIOCBASE, nr)

/* NuttX touchscreen ioctl definitions (see nuttx/input/touchscreen.h) ******/

#define _TSIOCVALID(c) (_FS_IOC_TYPE (c) == _TSIOCBASE)
#define _TSIOC(nr)     _FS_IOC (_TSIOCBASE, nr)

/* NuttX sensor ioctl definitions (see nuttx/sensor/ioctl.h) ****************/

#define _SNIOCVALID(c) (_FS_IOC_TYPE (c) == _SNIOCBASE)
#define _SNIOC(nr)     _FS_IOC (_SNIOCBASE, nr)

/* NuttX Analog (DAC/ADC) ioctl commands (see nuttx/analog/ioctl.h **********/

#define _ANIOCVALID(c) (_FS_IOC_TYPE (c) == _ANIOCBASE)
#define _ANIOC(nr)     _FS_IOC (_ANIOCBASE, nr)

/* NuttX PWM ioctl definitions (see nuttx/timers/pwm.h) *********************/

#define _PWMIOCVALID(c) (_FS_IOC_TYPE (c) == _PWMIOCBASE)
#define _PWMIOC(nr)     _FS_IOC (_PWMIOCBASE, nr)

/* NuttX Capture ioctl definitions (see nuttx/timers/capture.h) *************/

#define _CAPIOCVALID(c) (_FS_IOC_TYPE (c) == _CAPIOCBASE)
#define _CAPIOC(nr)     _FS_IOC (_CAPIOCBASE, nr)

/* NuttX USB CDC/ACM serial driver ioctl definitions ************************/

/* (see nuttx/usb/cdcacm.h) */

#define _CAIOCVALID(c) (_FS_IOC_TYPE (c) == _CAIOCBASE)
#define _CAIOC(nr)     _FS_IOC (_CAIOCBASE, nr)

/* NuttX battery driver ioctl definitions ***********************************/

/* (see nuttx/power/battery.h) */

#define _BATIOCVALID(c) (_FS_IOC_TYPE (c) == _BATIOCBASE)
#define _BATIOC(nr)     _FS_IOC (_BATIOCBASE, nr)

/* NuttX Quadrature Encoder driver ioctl definitions ************************/

/* (see nuttx/power/battery.h) */

#define _QEIOCVALID(c) (_FS_IOC_TYPE (c) == _QEIOCBASE)
#define _QEIOC(nr)     _FS_IOC (_QEIOCBASE, nr)

/* NuttX Audio driver ioctl definitions *************************************/

/* (see nuttx/audio/audio.h) */

#define _AUDIOIOCVALID(c) (_FS_IOC_TYPE (c) == _AUDIOIOCBASE)
#define _AUDIOIOC(nr)     _FS_IOC (_AUDIOIOCBASE, nr)

/* LCD character driver ioctl definitions ***********************************/

/* (see nuttx/include/lcd/slcd_codec.h */

#define _LCDIOCVALID(c) (_FS_IOC_TYPE (c) == _LCDIOCBASE)
#define _LCDIOC(nr)     _FS_IOC (_LCDIOCBASE, nr)

/* Segment LCD driver ioctl definitions *************************************/

/* (see nuttx/include/lcd/slcd_codec.h */

#define _SLCDIOCVALID(c) (_FS_IOC_TYPE (c) == _SLCDIOCBASE)
#define _SLCDIOC(nr)     _FS_IOC (_SLCDIOCBASE, nr)

/* Wireless driver character driver ioctl definitions ***********************/

/* (see nuttx/include/wireless/ioctl.h */

#define _WLCIOCVALID(c) (_FS_IOC_TYPE (c) == _WLCIOCBASE)
#define _WLCIOC(nr)     _FS_IOC (_WLCIOCBASE, nr)

/* Application Config Data driver ioctl definitions *************************/

/* (see nuttx/include/configdata.h */

#define _CFGDIOCVALID(c) (_FS_IOC_TYPE (c) == _CFGDIOCBASE)
#define _CFGDIOC(nr)     _FS_IOC (_CFGDIOCBASE, nr)

/* Timer driver ioctl commands **********************************************/

/* (see nuttx/include/timer.h */

#define _TCIOCVALID(c) (_FS_IOC_TYPE (c) == _TCIOCBASE)
#define _TCIOC(nr)     _FS_IOC (_TCIOCBASE, nr)

/* Joystick driver ioctl definitions ****************************************/

/* Discrete Joystick (see nuttx/include/input/djoystick.h */

#define _JOYIOCVALID(c) (_FS_IOC_TYPE (c) == _JOYBASE)
#define _JOYIOC(nr)     _FS_IOC (_JOYBASE, nr)

/* FIFOs and pipe driver ioctl definitions **********************************/

#define _PIPEIOCVALID(c) (_FS_IOC_TYPE (c) == _PIPEBASE)
#define _PIPEIOC(nr)     _FS_IOC (_PIPEBASE, nr)
...
#define _RTCIOCVALID(c) (_FS_IOC_TYPE (c) == _RTCBASE)
#define _RTCIOC(nr)     _FS_IOC (_RTCBASE, nr)

/* Relay driver ioctl definitions *******************************************/

/* (see nuttx/power/relay.h */

#define _RELAYIOCVALID(c) (_FS_IOC_TYPE (c) == _RELAYBASE)
#define _RELAYIOC(nr)     _FS_IOC (_RELAYBASE, nr)

/* CAN driver ioctl definitions *********************************************/

/* (see nuttx/can/can.h */

#define _CANIOCVALID(c) (_FS_IOC_TYPE (c) == _CANBASE)
#define _CANIOC(nr)     _FS_IOC (_CANBASE, nr)

/* Button driver ioctl definitions ******************************************/

/* (see nuttx/input/buttons.h */

#define _BTNIOCVALID(c) (_FS_IOC_TYPE (c) == _BTNBASE)
#define _BTNIOC(nr)     _FS_IOC (_BTNBASE, nr)

/* User LED driver ioctl definitions ****************************************/

/* (see nuttx/leds/usersled.h */

#define _ULEDIOCVALID(c) (_FS_IOC_TYPE (c) == _ULEDBASE)
#define _ULEDIOC(nr)     _FS_IOC (_ULEDBASE, nr)

/* Zero Cross driver ioctl definitions **************************************/

/* (see nuttx/include/sensor/zerocross.h */

#define _ZCIOCVALID(c) (_FS_IOC_TYPE (c) == _ZCBASE)
#define _ZCIOC(nr)     _FS_IOC (_ZCBASE, nr)

/* Loop driver ioctl definitions ********************************************/

/* (see nuttx/include/fs/loop.h */

#define _LOOPIOCVALID(c) (_FS_IOC_TYPE (c) == _LOOPBASE)
#define _LOOPIOC(nr)     _FS_IOC (_LOOPBASE, nr)

/* Modem driver ioctl definitions *******************************************/

/* see nuttx/include/modem/ioctl.h */

#define _MODEMIOCVALID(c) (_FS_IOC_TYPE (c) == _MODEMBASE)
#define _MODEMIOC(nr)     _FS_IOC (_MODEMBASE, nr)

/* I2C driver ioctl definitions *********************************************/

/* see nuttx/include/i2c/i2c_master.h */

#define _I2CIOCVALID(c) (_FS_IOC_TYPE (c) == _I2CBASE)
#define _I2CIOC(nr)     _FS_IOC (_I2CBASE, nr)

/* SPI driver ioctl definitions *********************************************/

/* see nuttx/include/spi/spi_transfer.h */

#define _SPIIOCVALID(c) (_FS_IOC_TYPE (c) == _SPIBASE)
#define _SPIIOC(nr)     _FS_IOC (_SPIBASE, nr)

/* GPIO driver command definitions ******************************************/

/* see nuttx/include/ioexpander/gpio.h */

#define _GPIOCVALID(c) (_FS_IOC_TYPE (c) == _GPIOBASE)
#define _GPIOC(nr)     _FS_IOC (_GPIOBASE, nr)

/* Contactless driver ioctl definitions *************************************/

/* (see nuttx/include/contactless/ioctl.h */

#define _CLIOCVALID(c) (_FS_IOC_TYPE (c) == _CLIOCBASE)
#define _CLIOC(nr)     _FS_IOC (_CLIOCBASE, nr)

/* USB-C controller driver ioctl definitions ********************************/

/* (see nuttx/include/usb/xxx.h */

#define _USBCIOCVALID(c) (_FS_IOC_TYPE (c) == _USBCBASE)
#define _USBCIOC(nr)     _FS_IOC (_USBCBASE, nr)

/* 802.15.4 MAC driver ioctl definitions ************************************/

/* (see nuttx/include/wireless/ieee802154/ieee802154_mac.h */

#define _MAC802154IOCVALID(c) (_FS_IOC_TYPE (c) == _MAC802154BASE)
#define _MAC802154IOC(nr)     _FS_IOC (_MAC802154BASE, nr)

/* Power-Related IOCTLs *****************************************************/

#define _PWRIOCVALID(c) (_FS_IOC_TYPE (c) == _PWRBASE)
#define _PWRIOC(nr)     _FS_IOC (_PWRBASE, nr)

/* Frame buffer character drivers *******************************************/

#define _FBIOCVALID(c) (_FS_IOC_TYPE (c) == _FBIOCBASE)
#define _FBIOC(nr)     _FS_IOC (_FBIOCBASE, nr)

/* NxTerm character drivers *************************************************/

#define _NXTERMVALID(c) (_FS_IOC_TYPE (c) == _NXTERMBASE)
#define _NXTERMIOC(nr)  _FS_IOC (_NXTERMBASE, nr)

/* NuttX RF ioctl definitions (see nuttx/rf/ioctl.h) ************************/

#define _RFIOCVALID(c) (_FS_IOC_TYPE (c) == _RFIOCBASE)
#define _RFIOC(nr)     _FS_IOC (_RFIOCBASE, nr)

/* Rptun drivers ************************************************************/

#define _RPTUNIOCVALID(c) (_FS_IOC_TYPE (c) == _RPTUNBASE)
#define _RPTUNIOC(nr)     _FS_IOC (_RPTUNBASE, nr)

/* Notectl drivers **********************************************************/

#define _NOTECTLIOCVALID(c) (_FS_IOC_TYPE (c) == _NOTECTLBASE)
#define _NOTECTLIOC(nr)     _FS_IOC (_NOTECTLBASE, nr)

/* Noteram drivers **********************************************************/

#define _NOTERAMIOCVALID(c) (_FS_IOC_TYPE (c) == _NOTERAMBASE)
#define _NOTERAMIOC(nr)     _FS_IOC (_NOTERAMBASE, nr)

/* Remote Control drivers ***************************************************/

#define _RCIOCVALID(c) (_FS_IOC_TYPE (c) == _RCIOCBASE)
#define _RCIOC(nr)     _FS_IOC (_RCIOCBASE, nr)

/* Hime drivers *************************************************************/

#define _HIMEMIOCVALID(c) (_FS_IOC_TYPE (c) == _HIMEMBASE)
#define _HIMEMIOC(nr)     _FS_IOC (_HIMEMBASE, nr)

/* Efuse drivers ************************************************************/

#define _EFUSEIOCVALID(c) (_FS_IOC_TYPE (c) == _EFUSEBASE)
#define _EFUSEIOC(nr)     _FS_IOC (_EFUSEBASE, nr)

/* Motor drivers ************************************************************/

#define _MTRIOCVALID(c) (_FS_IOC_TYPE (c) == _MTRIOBASE)
#define _MTRIOC(nr)     _FS_IOC (_MTRIOBASE, nr)

/* MATH drivers *************************************************************/

#define _MATHIOCVALID(c) (_FS_IOC_TYPE (c) == _MATHIOBASE)
#define _MATHIOC(nr)     _FS_IOC (_MATHIOBASE, nr)

/* MMCSD drivers ************************************************************/

#define _MMCSDIOCVALID(c) (_FS_IOC_TYPE (c) == _MMCSDIOBASE)
#define _MMCSDIOC(nr)     _FS_IOC (_MMCSDIOBASE, nr)

/* Bluetooth ioctl definitions **********************************************/

#define _BLUETOOTHIOCVALID(c) (_FS_IOC_TYPE (c) == _BLUETOOTHBASE)
#define _BLUETOOTHIOC(nr)     _FS_IOC (_BLUETOOTHBASE, nr)

/* Packet radio ioctl definitions *******************************************/

#define _PKRADIOIOCVALID(c) (_FS_IOC_TYPE (c) == _PKTRADIOBASE)
#define _PKRADIOIOC(nr)     _FS_IOC (_PKTRADIOBASE, nr)

/* LTE device ioctl definitions *********************************************/

#define _LTEIOCVALID(c) (_FS_IOC_TYPE (c) == _LTEBASE)
#define _LTEIOC(nr)     _FS_IOC (_LTEBASE, nr)

/* Video device ioctl definitions *******************************************/

#define _VIDIOCVALID(c) (_FS_IOC_TYPE (c) == _VIDIOCBASE)
#define _VIDIOC(nr)     _FS_IOC (_VIDIOCBASE, nr)

/* cellularctl() command definitions ****************************************/

#define _CELLIOCVALID(c) (_FS_IOC_TYPE (c) == _CELLIOCBASE)
#define _CELLIOC(nr)     _FS_IOC (_CELLIOCBASE, nr)

/* mipidsi driver ioctl definitions *****************************************/

#define _MIPIDSIIOCVALID(c) (_FS_IOC_TYPE (c) == _MIPIDSIBASE)
#define _MIPIDSIIOC(nr)     _FS_IOC (_MIPIDSIBASE, nr)

/* Wireless driver network ioctl definitions ********************************/

/* (see nuttx/include/wireless/wireless.h */

#define _WLIOCVALID(c) (_FS_IOC_TYPE (c) == _WLIOCBASE)
#define _WLIOC(nr)     _FS_IOC (_WLIOCBASE, nr)

/* boardctl() command definitions *******************************************/

#define _BOARDIOCVALID(c) (_FS_IOC_TYPE (c) == _BOARDBASE)
#define _BOARDIOC(nr)     _FS_IOC (_BOARDBASE, nr)
...
#endif /* __INCLUDE_NUTTX_FS_FS_IOCTL_H */
