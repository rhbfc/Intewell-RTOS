...
#define SPSR_EL_MASK		U(3)

#define SPSR_EL_EL0  (0)
#define SPSR_EL_EL1  (1)
#define SPSR_EL_EL2  (2)
#define SPSR_EL_EL3  (3)
...
#define SPSR_SS (1ULL << 21) //单步位
#define SPSRSS_SHIFT_MINUS_MDSCRSS_SHIFT (21-0)
...
#define ISS_BITS(x)			(((x) >> ESR_ISS_MASK) & ESR_ISS_SHIFT)
...
/*******************************************************************************
 * Definitions for Cache Level ID Registers
 ******************************************************************************/
#define CLIDR_LOC		    (U(7) << 24)
#define CLIDR_LOC_SHIFT		U(24)
#define CLIDR_LOUIS		    (U(7) << 21)
#define CLIDR_LOUIS_SHIFT	U(21)
#define CLIDR_CTYPE_MASK	U(7)
#define CLIDR_CTYPE_N		U(0)   /* no cache */
#define CLIDR_CTYPE_I		U(1)   /* I-Cache */
#define CLIDR_CTYPE_D   	U(2)   /* D-Cache */
#define CLIDR_CTYPE_ID   	U(3)   /* Seperate I & D Cache */
#define CLIDR_CTYPE_U   	U(4)   /* Unified Cache */

/*******************************************************************************
 * Definitions for Current Cache Size ID Registers
 ******************************************************************************/
#define CCSIDR_LINESIZE_MASK    U(7)
