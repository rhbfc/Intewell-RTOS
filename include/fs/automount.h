...
typedef CODE int (*automount_handler_t) (const struct automount_lower_s *lower,
                                         void *arg, bool inserted);
...
struct automount_lower_s {
    ...
    const char *blockdev;   /* Path to the block device */
    const char *mountpoint; /* Location to mount the volume */
    ...
    CODE int (*attach) (const struct automount_lower_s *lower,
                        automount_handler_t isr, void *arg);
    CODE void (*enable) (const struct automount_lower_s *lower, bool enable);
    CODE bool (*inserted) (const struct automount_lower_s *lower);
};
...
void *automount_initialize (const struct automount_lower_s *lower);
...
void automount_uninitialize (void *handle);
