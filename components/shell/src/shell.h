...
#define SHELL_EXPORT_CMD(_attr, _name, _func, _desc)                                               \
    ...
    SHELL_USED const ShellCommand shellCommand##_name SHELL_SECTION(".shell.command") = {          \
        .attr.value = _attr,                                                                       \
...
#define SHELL_EXPORT_VAR(_attr, _name, _value, _desc)                                              \
    const char shellCmd##_name[] = #_name;                                                         \
    const char shellDesc##_name[] = #_desc;                                                        \
    SHELL_USED const ShellCommand shellVar##_name SHELL_SECTION(".shell.command") = {              \
        .attr.value = _attr,                                                                       \
...
#define SHELL_EXPORT_USER(_attr, _name, _password, _desc)                                          \
    ...
    const char shellDesc##_name[] = #_desc;                                                        \
    SHELL_USED const ShellCommand shellUser##_name SHELL_SECTION(".shell.command") = {             \
...
#define SHELL_EXPORT_KEY(_attr, _value, _func, _desc)                                              \
    ...
    SHELL_USED const ShellCommand shellKey##_value SHELL_SECTION(".shell.command") = {             \
...
#define SHELL_CMD_ITEM(_attr, _name, _func, _desc)                                                 \
    {                                                                                              \
        .attr.value = _attr, .data.cmd.name = #_name, .data.cmd.function = (int (*)())_func,       \
        .data.cmd.desc = #_desc                                                                    \
    }
...
#define SHELL_VAR_ITEM(_attr, _name, _value, _desc)                                                \
    {                                                                                              \
        .attr.value = _attr, .data.var.name = #_name, .data.var.value = (void *)_value,            \
        .data.var.desc = #_desc                                                                    \
    }
...
#define SHELL_USER_ITEM(_attr, _name, _password, _desc)                                            \
    {                                                                                              \
        .attr.value = _attr | SHELL_CMD_TYPE(SHELL_TYPE_USER), .data.user.name = #_name,           \
        .data.user.password = #_password, .data.user.desc = #_desc                                 \
    }
...
#define SHELL_KEY_ITEM(_attr, _value, _func, _desc)                                                \
    {                                                                                              \
        .attr.value = _attr | SHELL_CMD_TYPE(SHELL_TYPE_KEY), .data.key.value = _value,            \
        .data.key.function = (void (*)(Shell *))_func, .data.key.desc = #_desc                     \
    }
...
typedef int (*sh_func0_t)(void);
typedef int (*sh_func1_t)(long);
typedef int (*sh_func2_t)(long, long);
typedef int (*sh_func3_t)(long, long, long);
typedef int (*sh_func4_t)(long, long, long, long);
typedef int (*sh_func5_t)(long, long, long, long, long);
typedef int (*sh_func6_t)(long, long, long, long, long, long);
typedef int (*sh_func7_t)(long, long, long, long, long, long, long);
typedef int (*sh_func8_t)(long, long, long, long, long, long, long, long);
typedef int (*sh_func9_t)(long, long, long, long, long, long, long, long, long);
typedef int (*sh_func10_t)(long, long, long, long, long, long, long, long, long, long);
typedef int (*sh_func11_t)(long, long, long, long, long, long, long, long, long, long, long);
typedef int (*sh_func12_t)(long, long, long, long, long, long, long, long, long, long, long, long);
typedef int (*sh_func13_t)(long, long, long, long, long, long, long, long, long, long, long, long,
                           long);
typedef int (*sh_func14_t)(long, long, long, long, long, long, long, long, long, long, long, long,
                           long, long);
typedef int (*sh_func15_t)(long, long, long, long, long, long, long, long, long, long, long, long,
                           long, long, long);
/**
